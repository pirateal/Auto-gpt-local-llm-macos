...
from prompt import get_pre_prompt

def add_pre_prompt():
    pre_prompt = get_pre_prompt()
    print(Fore.GREEN + pre_prompt + Style.RESET_ALL)

def main():
    add_pre_prompt()
    memory = get_memory(cfg.memory_backend)
    logging.basicConfig(level=logging.DEBUG)
    logger.info("Starting the AI program...")
...
def print_assistant_thoughts(assistant_reply):
    ...
    try:
        ...
        if not isinstance(assistant_reply_json, dict):
            logger.error("Expected a dictionary but got a string. Cannot process the response.")
            return  # Exit the function or use an appropriate error handling
...
# Enhancement: Refine logic and improve error handling.
# Modified for enhanced functionality

# Modified for enhanced functionality

# Enhancements for error handling and JSON parsing
